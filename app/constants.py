...
TOKEN_IS_MISSING = {"message": "The authorization token is  missing!"}
...
# Mentee availability
MENTEE_NOT_AVAIL_TOBE_MENTORED = {"message": "Mentee user is not available"
                                  " to be mentored."}
...
CANT_ACCEPT_UNINVOLVED_MENTOR_RELATION = {"message": "You cannot accept a"
                                          ...
                                          " not involved."}
USER_CANT_REJECT_REQUEST_FOR_MENTOR = {"message": "You cannot reject a"
                                       " mentorship request sent by yourself."}
...
USER_INPUTS_SPACE_IN_PASSWORD = {"message": "Password shouldn't contain"
                                 " spaces."}
TOKEN_HAS_EXPIRED = {"message": "The token is invalid!"}
...
TASK_WAS_ALREADY_ACHIEVED_SUCCESSFULLY = {"message": "Task was achieved"
                                          " successfully."}
