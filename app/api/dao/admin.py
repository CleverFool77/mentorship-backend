...
class AdminDAO:
    ...
    def assign_new_user(assigner_user_id, data):
        ...
        if assigner_user_id is new_admin_user_id:
            return constants.USER_CANNOT_BE_ASSIGNED_ADMIN_BY_USER, 403
        ...
        if new_admin_user:
            ...
            if new_admin_user.is_admin:
                return constants.USER_IS_ALREADY_AN_ADMIN, 400

            new_admin_user.is_admin = True
            new_admin_user.save_to_db()

            return constants.USER_IS_ALREADY_AN_ADMIN, 200
    ...
    def revoke_admin_user(revoker_user_id, data):
        ...
        if revoker_user_id is admin_user_id:
            return constants.USER_CANNOT_REVOKE_ADMIN_STATUS, 403
        ...
        if new_admin_user:
            ...
            if not new_admin_user.is_admin:
                return constants.USER_IS_NOT_AN_ADMIN, 400

            new_admin_user.is_admin = False
            new_admin_user.save_to_db()

            return constants.USER_ADMIN_STATUS_WAS_REVOKED, 200
