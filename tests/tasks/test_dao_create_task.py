...
class TestListTasksDao(TasksBaseTestCase):
    ...
    def test_create_task(self):
        ...
        expected_response = constants.TASK_WAS_CREATED_SUCCESSFULLY, 200
    ...
    def test_create_task_with_non_existing_mentorship_relation(self):
        ...
        expected_response = constants.MENTORSHIP_RELATION_DOES_NOT_EXIST, 404
    ...
    def test_create_task_with_mentorship_relation_non_accepted_state(self):
        ...
        expected_response = constants.MENTORSHIP_RELATION_NOT_IN_ACCEPT_STATE, 400
